export const CUSTOMERS = [
  { id: '1', name: 'Return to Factory', address: '123 Market Street, Downtown' },
  { id: '2', name: 'Puthra Reddy Garu', address: 'Anaparthy' },
  { id: '3', name: 'Manikanta Catering', address: 'Anaparthy Catering' },
